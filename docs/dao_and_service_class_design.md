...
class IBlogDAO(ABC):
    ...
    @abstractmethod
    def list_blogs(self, source_id: uuid.UUID | None, tag_id: uuid.UUID | None, page: int, count: int): ...

    @abstractmethod
    def count_blogs(self, source_id: uuid.UUID | None, tag_id: uuid.UUID | None): ...
